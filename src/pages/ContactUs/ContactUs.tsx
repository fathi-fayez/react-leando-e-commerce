            ...
            <section className="relative bg-gradient-to-br from-slate-900 to-slate-800 text-white py-24">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <h1 className="text-5xl md:text-6xl font-bold mb-6">
                        Get in Touch with <span className="text-emerald-400">Leando</span>
                    </h1>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8 mb-16">
                        {[
                            ...
                            >
                                <div
                                    className={`w-20 h-20 bg-${item.color}-100 rounded-full flex items-center justify-center mx-auto mb-6`}
                                >
                    ...
                    {/* Working Hours */}
                    <div className="bg-emerald-600 text-white rounded-2xl p-10 max-w-4xl mx-auto text-center">
                            ...
                            <form className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    <input
                                        ...
                                        className="w-full px-6 py-4 border border-gray-300 rounded-xl focus:outline-none focus:border-emerald-500 transition"
                                        required
                                    />
                                    <input
                                        type="text"
                                ...
                                <textarea
                                    ...
                                    className="w-full px-6 py-4 border border-gray-300 rounded-xl focus:outline-none focus:border-emerald-500 transition resize-none"
                                    required
                                ></textarea>
                                <button
                                    type="submit"
                                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-lg py-5 rounded-xl flex items-center justify-center gap-3 transition"
                                >
            ...
            <section className="py-20 bg-gray-900 text-white">
                <div className="max-w-4xl mx-auto text-center px-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <a
                            href="/faq"
                            className="inline-flex items-center bg-emerald-600 hover:bg-emerald-500 font-semibold text-lg px-10 py-4 rounded-full transition"
                        >
                            Browse FAQs
                        </a>
                        <a
                            href="/track-order"
                            className="inline-flex items-center border-2 border-emerald-500 hover:bg-emerald-500/10 font-semibold text-lg px-10 py-4 rounded-full transition"
                        >
                            Track Your Order
                        </a>
                    </div>
